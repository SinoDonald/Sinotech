...
namespace Sinotech_2025.Plotting
{
    class Methods
    {
        ...
        /*--------------+---------------+---------------+---------------+---------------+------*/
        public bool PrintToPDF(string strRVTPath, string strSheetSet, string strPrintSet, string strPDFOutPath,
                               string strProcessDate, string strLogfileFullPath, int intCntr, Document doc)
        {
