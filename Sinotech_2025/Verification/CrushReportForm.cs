...
using static Sinotech_2025.Verification.CrushReport;
using TaskDialog = Autodesk.Revit.UI.TaskDialog;

namespace Sinotech_2025.Verification
{
    public partial class CrushReportForm : System.Windows.Forms.Form
    {
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            if (treeView1.SelectedNode.Level.Equals(2))
            {
                try
                {
                    ...
                    ElementId id = new ElementId(Convert.ToInt64(content[1]));
        ...
        private void sure_Click(object sender, EventArgs e)
        {
            ...
            foreach (string checkedNodes in checkedNodesList)
            {
                ...
                ElementId id = new ElementId(Convert.ToInt64(nameId[1]));
