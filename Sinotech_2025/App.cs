...
namespace Sinotech_2025
{
    ...
    public class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButton manualPipeTagBtn = ribbonPanel.AddItem(new PushButtonData("ManualPipeTag", "手動標籤", addinAssmeblyPath, "Sinotech_2025.CSDSEM.ManualPipeTag")) as PushButton;
