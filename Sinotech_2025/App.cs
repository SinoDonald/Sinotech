...
namespace Sinotech_2025
{
    ...
    public class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButton autoPipeTagBtn = ribbonPanel.AddItem(new PushButtonData("AutoPipeTag", "管道標籤", addinAssmeblyPath, "Sinotech_2025.CSDSEM.AutoPipeTag")) as PushButton;
            ...
            PushButton autoNumberBtn = ribbonPanel.AddItem(new PushButtonData("AutoNumber", "自動編號", addinAssmeblyPath, "Sinotech_2025.CSDSEM.AutoNumber")) as PushButton;
            ...
            PushButton openingTagArrayBtn = ribbonPanel.AddItem(new PushButtonData("OpeningTagArrayBtn", "標籤排序", addinAssmeblyPath, "Sinotech_2025.CSDSEM.OpeningTagArray")) as PushButton;
