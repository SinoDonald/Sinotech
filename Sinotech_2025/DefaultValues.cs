...
namespace Sinotech_2025
{
    ...
    {
        // Revit version
        public static string s_strRevitVersion = "2018";
        // Path to main folder
        public static string s_strMainPrintPath = @"C:\AutoPDFPrint" + s_strRevitVersion + @"\";
        // Path to temp folder
        public static string s_strTempPrintPath = s_strMainPrintPath + @"Temp\";        // Path for log files
