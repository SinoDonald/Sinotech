                            ...
                            try
                            {
                                ...
                                if (newFamilyType != null)
                                {
                                    ...
                                    if (null != familyParamH && null != familyParamB)
                                    {
                                        ...
                                        {
                                            double bLength = UnitUtils.ConvertToInternalUnits(length, UnitTypeId.Millimeters);
                                            familyManager.Set(familyParamB, bLength);
                                        }
                                        if (null != familyParamH)
                                        {
                                            double hWidth = UnitUtils.ConvertToInternalUnits(width, UnitTypeId.Millimeters);
