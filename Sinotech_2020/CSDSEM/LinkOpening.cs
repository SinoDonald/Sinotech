...
using Sinotech_2020.CSDSEM;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using static Sinotech_2020.CSDSEM.ProfessionalCodeForm;
                ...
                try
                {
                    ...
                    if (professionalCodeForm.trueOrFalse == true)
                    {
                        ...
                        using (Transaction trans = new Transaction(doc, "移除重疊開口"))
                        {
                            ...
                            {
                                ElementId elemId = new ElementId(Convert.ToInt32(id.ToString()));
            ...
            foreach (XYZ xyz in crushElemInfo.xyzs)
            {
                ...
                try
                {
                    ...
                    if (trueOrFalse == false)
                    {
                        ...
                        newOpeningIds.Add((int)pipeOpen.Id.IntegerValue);
                        amount++;
                    }
                }
