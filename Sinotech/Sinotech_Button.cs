...
{    
    ...
    public class Sinotech_Button : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButton familyInstanceLockBtn = ribbonPanel.AddItem(new PushButtonData("FamilyInstanceLock", "元件鎖定", familyInstanceLockAsb, "FamilyInstanceLock.FamilyProtect")) as PushButton;
